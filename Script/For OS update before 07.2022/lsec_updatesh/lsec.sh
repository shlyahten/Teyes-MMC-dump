...
dd if=/dev/block/mmcblk0 bs=1024 count=2108928 | gzip > /storage/sdcard1/DUMP/ROM1.bin.gz.001
dd if=/dev/block/mmcblk0 bs=1024 count=2108928 skip=2108928 | gzip > /storage/sdcard1/DUMP/ROM1.bin.gz.002